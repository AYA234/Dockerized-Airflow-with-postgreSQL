...
def write_to_postres(**context):
    ...
    # engine = create_engine(f'postgresql://postgres:1234@db:5432/postgres')
    
    # # Replace 'your_table_name' with the name of the table where you want to write the data
    # table_name = 'winemag'
    ...
    #     print("Error writing data to PostgreSQL:", str(e))
